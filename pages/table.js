...
let guestList = [
  "Dato Martin Lim", "Dato 尤观成", "Dato 林亚财太平局绅", "杨庆权 BKT", "萧斐弘师傅", 
  "易荣源师傅", "锺道仁师傅", "高安定先生", "Dato Lim Teng Lun", "Dato Koh Chin Tuan", 
  "Rawang Michael", "狮总", "艺峰", "群乐", "南北龙狮总会", "周国庆先生", "李小萍", "Leon", 
  "李润福师傅", "台湾吕师傅", "新加坡威义", "澳洲振武馆", "新加坡腾勇", "Chris", "威少", 
  "Michael-Leon Fuat Hardware", "TargetFashion-Yit Meng ConstructionS/B", 
  "马来西亚龙艺总会", "Benson", "玄艺", "良胜", "龙溪", "依约", "雪州加影忠威龙狮团", 
  "Target Fashion", "Michael-Sonstar Engineering", "Michael-Ann Yak Siong Hardware", 
  "陈世强", "彭荣光", "许国雄", "邓炳财", "林明国", "郑博元", "温健安", "印尼光艺", "BB", 
  "Ricky", "Irene", "Boy", "Jessie Ng", "食为天海鲜酒家", "Target Fashion-Vegetarian", 
  "波德申龙艺龙狮协会", "柔佛居銮高峰龙狮体育会", "马六甲高峰龙狮体育会", "马六甲文威龙狮体育会", 
  "Torres Family", "SevenB Auto S/B", "William Yaw", "Tuan Lim", "Kevin Tann", 
  "吉隆坡谊艺醒狮团", "吉隆坡仁威龙狮体育会", "甲洞国兴龙狮团", "雪兰莪八打灵公中校友会龙狮团", 
  "Sun Ace Builder S/B", "高峰科技有限公司", "Lee Wai Weng Family", "Knight World RS", 
  "马接巴鲁红新月会龙狮团", "麻坡关圣宫", "耶耶亚哇洪仙大帝庙", "陈氏", "九洲", "卓越", 
  "UncleBen", "Mr Sew Kok Wah", "DnD", "JangYeou Family", "Aman Puri 逸富园", 
  "帝华达拿督公庙", "Lilian Lee Mei Kuen", "马来西亚弘德龙狮总会", "巴生弘德", "十五碑弘德", 
  "雪州士拉央弘德体育会", "Loyalzone Automobile S/B", "天灵宫龙狮体育会", 
  "Weng Lee StainlessStain Engineering", "Darren Family", "Joey Family", "鳌峰宫体育会", 
  "柔佛光艺", "柔佛古庙舞龙舞狮队", "柔佛州龙狮体育会", "柔佛巴株巴辖弘毅龙狮体育会", 
  "Kevin & Julie （Allianz）", "金山殿", "1010", "黄老仙师慈孝庙", "天灵宫龙狮体育会", 
  "甲洞弘德体育会", "梳邦弘德体育会", "新加坡艺威", "新加坡水莲宫", "吧口关圣宫", 
  "雪隆雄威馆武术龙狮培训团", "Ms Foo", "马来西亚群胜龙狮体育会", "马六甲文化", "三忠宫", 
  "金凤山", "晏斗", "柔佛士乃文扬体育会", "柔佛关羽堂龙狮体育会", "槟城大山脚宏伟", 
  "霆义龙狮团", "森美兰桂青", "居銮永安园", "槟城宏冠", "加影育华", "三艺龙狮体育会", 
  "雪州祥艺文化体育会", "吉打弘德", "鹤声", "冷甲弘德龙狮体育会", "安邦金英", "蒲种莲花宫", 
  "文採", "兴阁", "南艺", "团卫", "岭南鹤艺", "东胜", "新洋", "灵圣宫", "庆同乐", 
  "联善", "吉隆坡权艺", "白沙罗阮梁公圣佛庙", "制龙", "世龙", "釬权", "敦辉", "龙威", 
  "源林", "万挠玄龙体育会", "紫玄宫狮缘", "甲洞义肆", "甲洞义南阁", "雪州万撓自由醒狮团", 
  "胜威", "华体", "马六甲玄龙", "吉隆坡玄龙", "安邦玄龙", "雪隆炫武龙狮公会", 
  "波德申凤山寺", "文丁军警", "北海同桥社", "振德", "安顺三民", "巴生炫胜", "柔佛白鹤", 
  "东甲", "建造行", "张仙华", "毅胜坊", "龙芯", "嘉应会馆", "龙田", "义玄宫", 
  "吉隆坡德胜龙狮团", "霹雳江沙腾艺文化艺术坊", "柔佛光艺", "越南光艺", "吉隆坡光艺"
  ];
...
const initialSeatAssignments = {
    ...
    "17": ["陈世强", "彭荣光", "许国雄", "邓炳财", "林明国", "郑博元", "温健安"],
    "18": ["印尼光艺", "BB"],
    "19": ["Ricky", "Irene", "Boy"],
    "17": ["陈世强", "彭荣光", "许国雄", "邓炳财", "林明国", "郑博元", "温健安"],
    "18": ["印尼光艺", "BB"],
    ...
    "40": ["Knight World RS"],
    "41": ["马接巴鲁红新月会龙狮团", "麻坡关圣宫"],
    "42": ["耶耶亚哇洪仙大帝庙"],
    "43": ["陈氏", "九洲", "卓越", "UncleBen"],
    "41": ["马接巴鲁红新月会龙狮团", "麻坡关圣宫"],
    "42": ["耶耶亚哇洪仙大帝庙"],
    "43": ["陈氏", "九洲", "卓越", "UncleBen"],
...
const Seatings = () => {
  const [seatAssignments] = useState(initialSeatAssignments);
  ...
  const VIPSeat = ({ label }) => (
    <div className={`col-span-2 row-span-2 w-16 h-16 sm:w-24 sm:h-24 rounded-xl border-2 text-black
  ...
  return (
    ...
    <div className="max-w-full sm:max-w-4xl mx-auto p-4 sm:p-8">
      ...
      {/* Bottom Section */}
      <div className="mt-3">
        <div className="flex justify-end gap-2 sm:gap-4 mb-3 mr-5">
          {[95, 94, 93, 90, 89, 88].map(num => (
            <Seat key={num} number={num} />
          ))}
        </div>
        <div className="flex justify-end gap-2 sm:gap-4 mb-3 mr-10">
          {[96, 97, 98, 99].map(num => (
            <Seat key={num} number={num} />
          ))}
        </div>
        <div className="flex justify-end gap-2 sm:gap-4 mr-10">
        ...
        {/* Reserve Seats */}
        <div className="flex justify-end gap-2 sm:gap-4 mt-4 mr-16">
          <Seat number="R1" />
          <Seat number="R2" />
        </div>
      </div>
